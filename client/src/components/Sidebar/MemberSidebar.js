...
const MemberSidebar = () => {
  ...
  return (
    <div className=' bg-white h-full py-4 w-[230px] flex-none'>
    <div className='w-full flex flex-col items-center justify-center py-4'>
      <img src={current?.avatar || avatar} alt="logo" className='w-20 h-20 object-cover' />
      <small className='mt-2 text-lg'>{`${current?.lastname} ${current?.firstname}`}</small>
    </div>
    <div>
