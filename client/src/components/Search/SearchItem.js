...
import { color } from '../../ultils/contanst'
...
const SearchItem = ({name , activeClick ,changeActiveFilter , type = 'checkbox'}) => {
  ...
  return (
    <div
    className='p-3 cursor-pointer text-gray-500 relative gap-6 text-xs border border-gray-800 flex justify-between items-center'
